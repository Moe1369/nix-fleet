{ ... }: {
  flake.homeModules.gnome-usr-gnome-deck = { config, pkgs, ... }: {
    xdg.userDirs = {
      enable = true;
    ...
    home.file.".config/gtk-3.0/bookmarks".text = ''
      file:///home/deck/Bilder Bilder
      file:///home/deck/Code Code
      file:///home/deck/Dokumente Dokumente
      file:///home/deck/Downloads Downloads
      file:///home/deck/Musik Musik
      file:///home/deck/%C3%96ffentlich Öffentlich
      file:///home/deck/Schreibtisch Schreibtisch
      file:///home/deck/Videos Videos
      file:///home/deck/Vorlagen Vorlagen
   '';
    dconf.settings = {
      ...
      text = let
        ...
        entry = file: ''
          <wallpaper deleted="false">
            <name>${file}</name>
            <filename>/home/deck/.local/share/backgrounds/${file}</filename>
